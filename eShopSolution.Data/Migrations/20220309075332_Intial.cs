        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 3, 9, 14, 53, 32, 427, DateTimeKind.Local).AddTicks(2237)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 3, 9, 14, 53, 32, 447, DateTimeKind.Local).AddTicks(4219), 100000m, 200000m });
